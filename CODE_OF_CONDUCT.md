...
Octa is just a tool, but **the core of the Octa community is the people in it**. As such, we are committed to providing a friendly, safe and welcoming environment for all, regardless of gender, gender identity and expression, sexual orientation, ability, physical appearance, body size, race, age, socioeconomic status, religion (or lack thereof), or other marginalized aspect of comunity members. We expect all members of the Octa community to abide by this Code of Conduct whenever interacting in Octa venues (pull requests, GitHub issues, 1-1 or group chat, meetups, conferences, etc...)
...
* Roman Efremenko [email](mailto:roman.efremenko@gmail.com)
